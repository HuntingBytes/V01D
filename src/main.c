...
int main ()
{
    ...
    Texture2D texture = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\background1.png");
    Texture2D texture1 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\background2.png");
    Texture2D texture2 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\background3.png");
    Texture2D texture3 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\background4.png");
    Texture2D texture4 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\background5.png");
    Texture2D texture5 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\background6.png");
    int contaFrameFundo = 0;

    //inicialização das demais texturas
    Texture2D jogador = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\glitch_walk.png");
    Texture2D jogadorEsquerda = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\glitchesquerda.png");
    Texture2D jogadorParado = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\glitch_parado.png");
    Texture2D jogadorParadoEsquerda = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\glitchesquerdaparado.png");
    Texture2D player = jogador;
    Texture2D book = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\book.png");
    Texture2D easterEgg = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\pericles.png");
    Texture2D easterEggEsquerda = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\periclesEsquerda.png");
    Texture2D periclesParado = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\player\\periclesParado.png");
    Texture2D num0 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\0.png");
    Texture2D num1 = LoadTexture("C:\\Users\\lucas\\OneDrive\\Documentos\\IP1-2VA\\assets\\maps\\level1\\1.png");
    ...
    while (!WindowShouldClose())
    {
        ...
        UpdatePlayerCamera(&camera, &glitch, (float)texture.width);
        ...
        if(boolEnd1 == true && boolEnd2 == true && boolEnd3 == true && boolEnd4 == true)
        {
            ...
            DrawText("HELL YEAH NOW WE\nGOT BUSINESS", screenWidth/4, screenHeight/4, 50, LIGHTGRAY);
            DrawTextRec(GetFontDefault(), "Testando", (Rectangle){30, 30, 200, 200}, 40, 10, true, WHITE);
        }
        ...
        {
            DrawTexture(texture, 0, 0, BLACK);
            DrawText("CARALHO VIADO", screenWidth/4, screenHeight/4, 50, RED);
            DrawTextRec(GetFontDefault(), "PERICÃO NERVOSO", (Rectangle){30, 30, 200, 200}, 40, 10, true, WHITE);
        }
